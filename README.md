...
C4 model of the wattnet platform architecture. Includes context, container, component, and code-level diagrams documenting the system’s structure and interactions.
